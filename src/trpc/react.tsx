    ...
    api.createClient({
      links: [
        ...
        splitLink({
          ...
          // its Response. The streaming link returns the Response before
          // the procedures finish, so any revalidation a mutation issues
...
export { api, type RouterInputs, type RouterOutputs, TRPCReactProvider };
